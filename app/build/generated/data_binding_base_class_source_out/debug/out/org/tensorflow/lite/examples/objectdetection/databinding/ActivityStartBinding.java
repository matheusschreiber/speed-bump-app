...
public final class ActivityStartBinding implements ViewBinding {
  ...
  @NonNull
  public final RelativeLayout cameraModeGoBack;
  ...
  private ActivityStartBinding(@NonNull CoordinatorLayout rootView, @NonNull TextView appTitleBar,
    ...
    this.cameraModeGoBack = cameraModeGoBack;
  ...
  public static ActivityStartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.cameraModeGoBack;
      RelativeLayout cameraModeGoBack = ViewBindings.findChildViewById(rootView, id);
      if (cameraModeGoBack == null) {
        break missingId;
      }
