...
class ObjectDetectorHelper(
    ...
    private lateinit var signDetectedListener: OnSignDetectedAlert

    init {
        setupObjectDetector()
        signDetectedListener = context as OnSignDetectedAlert
    }
    ...
    fun setupObjectDetector() {
        ...
        val modelName =
            when (currentModel) {
                ...
                TINY_WBLUR_2 -> "40k_with_blur_tiny_v2.tflite"
